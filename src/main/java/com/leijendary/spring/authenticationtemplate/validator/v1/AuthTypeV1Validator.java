...
import static com.leijendary.spring.authenticationtemplate.data.AuthType.EMAIL;
import static com.leijendary.spring.authenticationtemplate.data.AuthType.MOBILE;
import static java.util.Arrays.asList;
import static java.util.Optional.ofNullable;

public class AuthTypeV1Validator implements ConstraintValidator<AuthTypeV1, String> {

    private static final List<String> VALID_TYPES = asList(EMAIL, MOBILE);
