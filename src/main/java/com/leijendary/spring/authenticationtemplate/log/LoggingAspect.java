package com.leijendary.spring.authenticationtemplate.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.leijendary.spring.authenticationtemplate..*.*(..))")
    public void includedPointcut() {}

    @Pointcut(
            "execution(* com.leijendary.spring.authenticationtemplate.config..*.*(..)) || " +
            "execution(* com.leijendary.spring.authenticationtemplate.filter..*.*(..)) || " +
            "execution(* com.leijendary.spring.authenticationtemplate.log..*.*(..)) || " +
            "execution(* com.leijendary.spring.authenticationtemplate.Application..*(..))")
